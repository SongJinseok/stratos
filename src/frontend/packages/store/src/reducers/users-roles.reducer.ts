...
export function UsersRolesReducer(state: UsersRolesState = defaultState, action: Action): UsersRolesState {
  switch (action.type) {
    ...
    case UsersRolesActions.SetOrgRole:
      ...
      return setRole(state, setOrgRoleAction.orgGuid, setOrgRoleAction.orgName, null, null, setOrgRoleAction.role, setOrgRoleAction.setRole);
    case UsersRolesActions.SetSpaceRole:
      const setSpaceRoleAction = action as UsersRolesSetSpaceRole;
      return setRole(state, setSpaceRoleAction.orgGuid, setSpaceRoleAction.orgName, setSpaceRoleAction.spaceGuid, setSpaceRoleAction.spaceName, setSpaceRoleAction.role, setSpaceRoleAction.setRole);
